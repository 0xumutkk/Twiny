...
export function ApprovalCard(props: ApprovalCardProps) {
    ...
    return (
      <section style={successWrap}>
        ...
        <h2 className="tw-serif" style={successAmount}>
          +{rewardMON}
          <span className="tw-mono" style={successUnit}>
            MON
          </span>
        </h2>
    ...
    return (
      <section style={signingWrap}>
        <div style={handoffVisual}>
          ...
          >
            <path
              d="M 36 36 Q 55 55 78 78"
              stroke="var(--tw-text-tertiary)"
              strokeWidth="1.5"
              strokeDasharray="3 4"
              fill="none"
              strokeLinecap="round"
        ...
        <h2 className="tw-serif" style={signingTitle}>
          Sign in your wallet.
        </h2>
  ...
  return (
    <section
      style={{
        ...approvalWrap,
        background: isHigh ? "var(--tw-danger-soft)" : "transparent",
      }}
    >
      ...
      <h2 className="tw-serif" style={approvalTitle}>
        {isHigh
          ? "Approve this wallet action?"
          : `Claim ${rewardMON} MON from ${campaignName}?`}
      </h2>
      ...
      <div
        ...
        style={{
          ...actionCard,
          borderColor: isHigh ? "var(--tw-danger)" : "var(--tw-border)",
        }}
      >
        <div
          style={{
        ...
        >
          ...
          <div
            ...
            style={{
              ...actionCode,
              color: isHigh ? "var(--tw-danger)" : "var(--tw-text)",
            }}
          >
            {onChainAction}
          </div>
        ...
        <div style={{ padding: "4px 16px" }}>
          <KV
            ...
            mono
            valueColor={
              isHigh ? "var(--tw-text-secondary)" : "var(--tw-monad-deep)"
            }
          />
          <div className="tw-hr" />
          ...
          <KV
            k="Cloud"
            v={cloudUsed ? "Used" : "Not used"}
            valueColor={cloudUsed ? "var(--tw-warn)" : "var(--tw-ok)"}
          />
        </div>
          ...
          >
            <div style={riskNoteTitle}>
              <Icon
                name="shield"
                size={15}
                color={isHigh ? "var(--tw-danger)" : "var(--tw-warn)"}
                strokeWidth={1.8}
              />
        ...
        {!isHigh && (
          <div style={preparedNote}>
            ...
            <span>
              {isMedium
                ? "Confirm the recipient before approving."
                : "Prepared. Your wallet signs."}
            </span>
          </div>
        )}
      </div>
      ...
      {status === "error" && (
        <div style={errorText}>Transaction failed. Please try again.</div>
      )}
    </section>
  );
}
...
function KV({
  ...
  return (
    <div style={kv}>
      ...
      <span
        className={mono ? "tw-mono" : undefined}
        style={{ ...kvValue, color: valueColor ?? "var(--tw-text)" }}
      >
        {v}
      </span>
    </div>
